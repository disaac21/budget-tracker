    ...
    return (
        <section className="bg-card border border-border rounded-2xl shadow-sm overflow-hidden">
            <div className="p-4 border-b border-border bg-slate-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <button className="text-sm font-semibold text-primary hover:text-primary transition">
                    View All
                </button>
            </div>
                ...
                <div className="p-4 border-t border-border bg-slate-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="px-3 py-2 rounded-lg border border-border bg-card text-sm font-medium text-secondary hover:bg-slate-100 transition disabled:opacity-50">
                            Previous
                        </button>

                        <button className="w-9 h-9 rounded-lg bg-primary text-white text-sm font-bold">
                            {currentPage}
                        </button>
